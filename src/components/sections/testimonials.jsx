                    ...
                    <div className="row">
                        <div className="col-lg-12">
                            ...
                            <Swiper
                                ...
                                modules={[Navigation]}
                            >
                                {testimonialsData.map(({ id, position, review, src }) => <SwiperSlide key={id} > <Card img={src} position={position} review={review} /> </SwiperSlide>)}
                            </Swiper>
                            <SlideUp>
...
const Card = ({ img, position, review }) => {
    return (
        <SlideUp>
            <div className="testimonial-item">
                <div className="author">
                    <Image width={140} height={60} sizes='100vw' src={img} alt={position} />
                </div>
